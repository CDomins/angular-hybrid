...
(function () {
  ...
  TaskController.$inject = ["TaskService", "TaskManagerServiceService"];

  function TaskController(TaskService, TaskManagerServiceService) {
    var vm = this;
    ...
    function loadTasks() {
      ...
      TaskManagerServiceService.getAllTaskRxjs().subscribe({
        next: (categories) => {
