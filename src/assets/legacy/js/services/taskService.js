...
(function () {
  ...
  TaskService.$inject = ["$ngRedux"];

  function TaskService(StoreService) {
    var vm = this;
    ...
    function getTaskById(id) {
      return _.find(store.getState().tasks, { id: id });
    }
      ...
      var sampleTasks = [
        {
          ...
          description:
            "Finish the task management application with MVC structure",
          priority: "high",
        ...
        },
        {
          ...
          description:
            "Research best practices for migrating from AngularJS to Angular 14",
          priority: "medium",
        ...
        },
        {
          ...
          description:
            "Install Node.js, Angular CLI, and other necessary tools",
          priority: "low",
